...
public class AutocompleteTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeFilterSpinner = findViewById(R.id.autocomplete_type_filter);
        ...
        useTypeFilterCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        findViewById(R.id.autocomplete_fragment_update_button).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.autocomplete_activity_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.fetch_autocomplete_predictions_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
