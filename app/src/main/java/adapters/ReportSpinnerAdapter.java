...
public class ReportSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {

    private final Context mContext;
    private ArrayList<String> reportData;

    public ReportSpinnerAdapter(Context context, ArrayList<String> reportData) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = li.inflate(R.layout.report_dropdown, null);
    ...
    public View getView(int i, View view, ViewGroup viewgroup) {
        ...
        LayoutInflater li = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = li.inflate(R.layout.report_spinner_row, null);/*
