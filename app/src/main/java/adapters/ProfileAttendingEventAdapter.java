...
/**
 * Adapter to set  event list attending by a user
 */

public class ProfileAttendingEventAdapter extends RecyclerView.Adapter<ProfileAttendingEventAdapter.EventsVH> {
    ...
    private ArrayList<UserAttendingEventResponse> events;
    private Context context;
    private String mMonth, mWeek;
    Date date;
    OnItemClickListener listener;

    public ProfileAttendingEventAdapter(Context context, ArrayList<UserAttendingEventResponse> eventListData, OnItemClickListener listener) {
        this.context = context;
        events = eventListData;
        this.listener = listener;
    }

    public List<UserAttendingEventResponse> getEvents() {
        return events;
    }

    public void setEvents(ArrayList<UserAttendingEventResponse> events) {
        this.events = events;
    }
    ...
    public void onBindViewHolder(EventsVH holder, final int position) {
        ...
        final UserAttendingEventResponse event = events.get(position);
