...
public class UserEventListAdapter extends RecyclerView.Adapter<UserEventListAdapter.EventsVH> {

    private ArrayList<CreatedEvent> events;
    ...
    public UserEventListAdapter(Context context, ArrayList<CreatedEvent> eventListData) {
    ...
    public void setEvents(ArrayList<CreatedEvent> events) {
        this.events = events;
    }
    ...
    public void onBindViewHolder(final EventsVH holder, int position) {
        ...
        final CreatedEvent event = events.get(position);
        ...
        if (eventType == 1) {
            ...
            holder.mEventStatus.setImageResource(R.drawable.deactive_live);
        }
                            ...
                            .setOnSliderClickListener(new BaseSliderView.OnSliderClickListener() {
                                ...
                                public void onSliderClick(BaseSliderView slider) {
                                    ...
                                    ((PublicUserProfileActivity) context).getSupportFragmentManager()
                                            .beginTransaction()
                                            .replace(R.id.containeruserprofile, optionsFrag, "OptionsFragment")
