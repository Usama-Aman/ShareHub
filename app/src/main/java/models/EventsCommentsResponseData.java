...
public class EventsCommentsResponseData {
    ...
    public class Data {
        ...
        @SerializedName("data")
        @Expose
        private List<UserInfoData> data = null;
    ...
    public static class UserInfoData {
        ...
        @SerializedName("ecomment_dateadded")
        @Expose
        private String ecommentDateadded;
        ...
        public String getEcommentDateadded() {
            return ecommentDateadded;
        }

        public void setEcommentDateadded(String ecommentDateadded) {
            this.ecommentDateadded = ecommentDateadded;
        }
